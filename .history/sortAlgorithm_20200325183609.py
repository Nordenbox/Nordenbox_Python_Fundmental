...
r = map(my_sort, [[1, 2, 5, 1, 3, 1, 5, 2, 6, 1], [2, 3, 2, 5, 6, 2, 5, 5, 1, 6], [3, 1, 1, 3, 5, 3, 4, 2, 3, 3], [3, 1, 4, 6, 4, 4, 6, 1, 6, 6], [3, 3, 3, 5, 2, 3, 2, 5, 1, 2], [3, 4, 6, 2, 6, 2, 3, 2, 6, 6], [4, 3, 1, 5, 4, 4, 6, 5, 6, 6], [4, 4, 5, 3, 3, 1, 1, 1, 4, 4], [4, 5, 3, 4, 5, 2, 4, 1, 6, 4], [6, 3, 6, 6, 2, 5, 5, 5, 6, 2]]
print(list(r))