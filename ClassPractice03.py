...
student1 = Student('韩梅梅','学生')
student2 = Programmer('李雷','程序员')
print(student1.name,student1.job)
student1.count_time(100,0.8)
print(student1.time_effective)
print(student2.name,student2.job)
student2.count_time(100,1)
